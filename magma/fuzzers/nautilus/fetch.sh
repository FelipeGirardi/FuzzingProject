...
git clone --no-checkout 'https://github.com/nautilus-fuzz/nautilus.git' "$FUZZER/repo/nautilus"
git -C "$FUZZER/repo/nautilus" checkout 7b013f2ef0531fe4dbe24e34169653cce1f2a3b9
